...
movies_vectorstore = FAISS.load_local("/home/prem/Downloads/movies_faiss_index", embeddings, allow_dangerous_deserialization = True)
recipies_vectorstore = FAISS.load_local("/home/prem/Downloads/recipies_faiss_index", embeddings, allow_dangerous_deserialization = True)
